...
if (<?=$_SESSION["kanri_flg"]?>==1) {
    $(".navbar-header").html('<a class="navbar-brand" href="kadai_index.php">ブックマーク登録</a><a class="navbar-brand" href="kadai_select.php"><b>ブックマーク表示</b></a><a class="navbar-brand" href="kadai_index_user.php">ユーザー登録</a><a class="navbar-brand" href="kadai_select_user.php">ユーザー表示</a>')
  }else{
    $(".navbar-header").html('<a class="navbar-brand" href="kadai_index.php">ブックマーク登録</a><a class="navbar-brand" href="kadai_select.php"><b>ブックマーク表示</b></a>')
  }
</script>
